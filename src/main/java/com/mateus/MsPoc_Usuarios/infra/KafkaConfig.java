...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, UserRequest> consumerFactory() {
        ...
        JsonDeserializer<UserRequest> deserializer =
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "users-ms");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UserRequest>
